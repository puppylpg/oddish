...
def final_categories(categories):
    ...
    log.info('Blacklist categories: {}'.format(CATEGORY_BLACK_LIST))
    log.info('Whitelist categories: {}'.format(CATEGORY_WHITE_LIST))
    ...
    log.info('Final categories: {}'.format(final))
    return final
